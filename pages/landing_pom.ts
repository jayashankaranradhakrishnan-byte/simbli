...
export class landingPage {
    ...
    get pricing(): Locator {
        return this.landingPageHeaderContainer.getByText(
            'Pricing',
            { exact: true }
        );
    }
    ...
    get aboutus(): Locator {
        return this.landingPageHeaderContainer.getByText('About Us', { exact: true });
    ...
    get contact(): Locator {
        return this.landingPageHeaderContainer.getByText('Contact', { exact: true });
    }

    get nav_getstart_btn(): Locator {
        return this.landingPageHeaderContainer.getByRole('button', { name: 'Get Started' });
    }
    ...
    get subscribeNewsletterLink(): Locator {
        return this.page.locator(
            'p.subscribe-newsletter-link'
        );
    }

    get footer_landingpage(): Locator {
        return this.page.locator('div.d-flex.flex-column.flex-lg-row.justify-content-between.align-items-center.px-3.year-copy-inner');
    }
    ...
    async landing_page() {
        ...
        const landingPageHeaderCss =
            await validator.getContainerCss(
        ...
        await validator.validateVisibility(
            this.meetYourAiAgentTeam,
            true
        );
        ...
        const footer = await validator.getContainerCss(
